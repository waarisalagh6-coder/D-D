...
// ---- Canvas (initialized in startGame after screen is visible) ----
const canvas = document.getElementById('game-canvas');
let ctx = null; // assigned in startGame()
...
function startGame(player, room, code) {
  ...
  // Show game screen (use inline style to bypass CSS specificity issues)
  document.getElementById('lobby-screen').style.display = 'none';
  document.getElementById('game-screen').style.display  = 'flex';

  // Canvas must be visible before we can initialize it
